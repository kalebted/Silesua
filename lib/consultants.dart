...
class _ConsultantsState extends State<Consultants> {
  ...
  void UpadateList(String value){
    setState(() {
      display_list = consultants_on_call.where((element) => element.name.toLowerCase().contains(value.toLowerCase())).toList();
    });
  }
                      ...
                      children: [
                        SizedBox(
                          ...
                          child: ClipRRect(
                            ...
                            child: Image.asset(consultants_on_call[index].image, fit: BoxFit.cover,)
                          ),
                        ),
                        // SizedBox(width: 10),
                        Column(
                          ...
                          children: [
                            Text(consultants_on_call[index].name, style: TextStyle(fontFamily: 'Poppins', fontSize: 18,fontWeight: FontWeight.bold),),
                            Text(consultants_on_call[index].specialization),
